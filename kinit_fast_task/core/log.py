...
class LoguruLogger(metaclass=Singleton):
    ...
    def _log(self, level: str, *args: Any, is_verbose: bool = False, depth: int = 0, log_id: str = None) -> None:
        """
        记录日志消息
    ...
    def debug(self, *args: Any, is_verbose: bool = False, depth: int = 0, log_id: str = None) -> None:
        """
    ...
    def info(self, *args: Any, is_verbose: bool = False, depth: int = 0, log_id: str = None) -> None:
        """
    ...
    def success(self, *args: Any, is_verbose: bool = False, depth: int = 0, log_id: str = None) -> None:
        """
    ...
    def warning(self, *args: Any, is_verbose: bool = False, depth: int = 0, log_id: str = None) -> None:
        """
    ...
    def error(self, *args: Any, is_verbose: bool = False, depth: int = 0, log_id: str = None) -> None:
        """
    ...
    def critical(self, *args: Any, is_verbose: bool = False, depth: int = 0, log_id: str = None) -> None:
        """
    ...
    def start(self, msg: str = "BEGIN", depth: int = 0) -> str:
        """
        输出任务开始信息
        ...
        self._log("INFO", f"=======", depth=depth + 1, log_id=log_id)
        self._log("INFO", msg, depth=depth + 1, log_id=log_id)
        return log_id

    def end(self, msg: str = None, depth: int = 0, log_id: str = None) -> None:
        """
        输出任务结束信息
